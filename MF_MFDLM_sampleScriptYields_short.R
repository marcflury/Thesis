...
# MCMC parameters:
nsims =  1.5e4 		# Total number of simulations
...
Beta <- colMeans(postBetaAll[-(1:burnin),,])
d <- colMeans(postDAll[-(1:burnin),,])
Et <- colMeans(postEtAll[-(1:burnin),])
ht <- colMeans(postHtAll[-(1:burnin),,])
gammaSlopes <- colMeans(postGammaSlopesAll[-(1:burnin),])
